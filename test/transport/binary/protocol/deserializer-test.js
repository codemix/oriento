...
describe('Deserializer', function() {
  it('should go fast!', function() {
    ...
    console.log('Done in ' + total + 's, ', (limit / total).toFixed(3), 'documents / sec',
      (((size / total) / 1024) / 1024).toFixed(3), ' Mb / sec');
  });

  describe('deserialize()', function() {
    it('should parse a very simple record', function() {
      var input = 'OUser@foo:123,baz:"bazx\\"za",int:1234,true:true,false:false,null:null,date:123456a,' +
        'rid:#12:10,array:[1,2,3,4,5],twice:"\\"127.0.0.1\\""';
  ...
  describe('eatBag()', function() {
    it('should eat a RID bag', function() {
      ...
      parsed[0].should.eql('aGVsbG8gd29ybGQ=');
      parsed[1].length.should.equal(0);
    });
