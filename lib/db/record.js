  ...
  return promise
    .then(function(cluster) {
      ...
      return self.send('record-create', {
        segment: options.segment !== null && typeof options.segment !== 'undefined' ? +options.segment : -1,
        cluster: rid.cluster,
        record: record
      });
    })
...
exports.delete = function(record, options) {
  ...
  return this.send('record-delete', {
    cluster: rid.cluster,
    position: rid.position,
    version: record['@version'] !== null && typeof record['@version'] !== 'undefined' ? +record['@version'] : -1,
    mode: options.mode || 0
  })
    .then(function(response) {
      return record;
